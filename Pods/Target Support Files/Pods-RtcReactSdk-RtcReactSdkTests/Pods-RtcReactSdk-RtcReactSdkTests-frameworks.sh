...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ReactNativeIncallManager/ReactNativeIncallManager.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-webrtc/react_native_webrtc.framework"
fi
